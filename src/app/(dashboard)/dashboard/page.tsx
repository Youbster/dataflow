...
export default function DashboardPage() {
  ...
  async function runPlaylistRequest({
    ...
    // Generation now uses cached Supabase taste data, so it should complete
    // directly without the unreliable Vercel background worker/polling path.
    ...
    try {
      ...
      const msg =
        err instanceof Error
          ? err.name === "AbortError"
            ? "Generation took too long. Try 20 min, add a clearer genre, or sync Spotify first."
            : err.message
